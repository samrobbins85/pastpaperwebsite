...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.3/css/bootstrap.min.css" integrity="sha384-Zug+QiDoJOrZ5t4lssLdxGhVrurbmBWopoEl+M6BdEfwnCJZtKxi1KgxUyJq13dy" crossorigin="anonymous">
    ...
    function runUser(str) {
        ...
        if (str == "") {
            ...
            xmlhttp.open("GET","Test/index2.php?delete="+str,true);
            xmlhttp.send();
            location.reload();
        }
...
<!--     <style type="text/css">
   body { background: #333 !important; } /* Adding !important forces the browser to overwrite the default style applied by Bootstrap */
</style> -->
<style type="text/css">
body {
  overflow-x:hidden;
...
$x++; 
if ($x==49) {
echo "You are not signed in, please sign in using the button below";
echo "<div class='g-signin2' data-display='inline-block' data-whitespace='no-wrap' data-onsuccess='onSignIn' data-theme='dark'></div>";
...
<form>
  ...
  <label for='chooseyear' class='col-sm-2 col-md-1 col-form-label'>Subject</label>
  <div class='col-sm-7'>
